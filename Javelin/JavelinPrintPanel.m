...
#import "JavelinPrintPanel.h"


/** <title>JavelinPrintPanel</title>
...
/**
 ...
 <p>
 JavelinPrintPanel provides a standard print panel allowing the user to 
 ...
 */ 
@implementation JavelinPrintPanel
...
/** Creates ( if needed) and returns a shared instance of the
 JavelinPrintPanel panel.
 */
+ (JavelinPrintPanel *)printPanel
{
	if (shared_instance == nil)
    {
		shared_instance = [[JavelinPrintPanel alloc] init];
    }
...
@implementation JavelinPrintPanel (GSPrivate)
- (void)_updateFromPrintInfo: (NSPrintInfo*)info
{
	id control;
	int layout;
